...
(function (DataConverterUtils) {
    ...
    * */
    ...
    function guessType(value, converter) {
        var result = 'string';
        if (typeof value === 'string') {
            var trimedValue = DataConverterUtils.trim("".concat(value)), decimalRegExp = converter.decimalRegExp;
            var innerTrimedValue = DataConverterUtils.trim(trimedValue, true);
            if (decimalRegExp) {
